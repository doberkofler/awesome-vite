...
- [vite-plugin-merge-css](https://github.com/doberkofler/vite-plugin-merge-css) - A vite plugin that automatically merges all css chunks for each entry point into a single css file.
